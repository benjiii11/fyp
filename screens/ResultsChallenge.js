...
import { getHighScoreChallenge } from '../logic/scoringchallenge';

export default function ResultsChallenge({ route, navigation }) {
  ...
  useEffect(() => {
    ...
    const loadHighScore = async () => {
      const stored = await getHighScoreChallenge(category);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.text}>High Score ({category} - Challenge): {highScore}</Text>
